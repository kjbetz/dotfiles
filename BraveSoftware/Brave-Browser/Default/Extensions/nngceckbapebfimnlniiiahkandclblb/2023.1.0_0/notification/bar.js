...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function load() {
    ...
    document.getElementById("logo").src = isVaultLocked ? chrome.runtime.getURL("images/icon38_locked.png") : chrome.runtime.getURL("images/icon38.png");
